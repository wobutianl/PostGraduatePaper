...
\usepackage[below]{placeins}  % 允许上一个section的浮动图形出现在下一个section的开始部分,
                              % 还提供\FloatBarrier命令,使所有未处理的浮动图形立即被处理
...
%\def\a{true}
%\ifx\a\useyap
%\usepackage[dvipdf, %即ghostscript+dvips
%            CJKbookmarks=true,
%            bookmarksnumbered=true,
%            bookmarksopen=true,
%            colorlinks=false,       % 可以改为true看看有什么不同。最后打印的时候可以改成false，这样字体都是黑色
...
%            breaklinks=true
%            ]{hyperref}
%\hypersetup{colorlinks, citecolor=black,linkcolor=black,pdftex}
%\else
%\usepackage[dvipdfm,
%            CJKbookmarks=true,
%            bookmarksnumbered=true,
